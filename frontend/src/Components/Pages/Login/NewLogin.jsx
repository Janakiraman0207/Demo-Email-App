...
export const NewLogin = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-start w-full max-w-[237px] h-[63px] gap-[12px]">
        <p className="inter-bold text-[#000000] text-[28px] leading-[34px]">
          Welcome Back 👋
        </p>

...
export const AuthCardLayout = ({ isVisible, variant }) => {
  ...
  return (
    <div className="relative w-[598px] h-[748px]">
      <h1
        className="absolute bottom-[697px] left-[60px] text-[24.18px] text-black self-start krona-one-regular">
        STACKLY
      </h1>
      <FadeWrapper isVisible={isVisible}>
        <>
          ...
          {activeSlide.type === "image" && (
            ...
            >
              <img
                ...
                className="max-w-[480px] max-h-full object-contain"
              />
            </div>
          )}
          <div
          ...
          {slides.length > 1 && (
            <div
              className="flex items-center justify-center absolute left-[540px] top-[625px] w-[48px] h-[100px] rounded-[18px] bg-[#0E0929] cursor-pointer"
            >

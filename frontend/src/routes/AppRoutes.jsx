...
const Calander = lazy(() => import("../Components/Pages/Calander/Calander"));
const ChatHome = lazy(() => import("../Components/Pages/Chat/ChatHome"));
import { DrivePage } from "../Components/Pages/Drive/DrivePage";
const Settings = lazy(() => import("../Components/Pages/Settings/Settings"));
const SuccessPopUp = lazy(() => import("../Components/Pages/Calander/NewEvents/SuccessPopUp")); // <-- Added import
